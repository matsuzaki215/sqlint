/**
 * BigQuery reserved keywords, functions and Operators
 */
...
const RESERVED_KEYWORDS = [
    ...
    "WINDOW", "WITH", "WITHIN", "FUNCTION", "TEMPORARY",
    "YEAR", "QUARTER", "MONTH", "WEEK", "DAY",                // date_part
    "MICROSECOND", "MILLISECOND", "SECOND", "MINUTE", "HOUR"  // date_part
];
